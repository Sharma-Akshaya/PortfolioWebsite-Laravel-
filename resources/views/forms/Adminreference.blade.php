 ...
 <!---`reference`(`Name`, `Img`, `JobTitle`, `Recommendation`, `IDGeneration`)-->
		...
		<div class="rsideAdmin">
			<div class="outterakbox">
				<form action="{{action('FormController@adminref')}}" method="POST">
					{{csrf_field()}}
					<div class="head">
						<h2>REFERENCES DETAILS ACCESS</h2>
					</div>
					<div class="elementsAdminAbout">
						<p>Name</p>
					
						<input type="text" name="Name"  id="FormInput" required>
					</div>
					<div class="elementsAdminAbout">
						<p>Photo</p>
					
						<input type="file" name="Img"  id="FormInput" required>
					</div>
					<div class="elementsAdminAbout">
						<p>Job Title</p>
						<input type="text" name="JobTitle"  id="FormInput" required>
					</div>
					<div class="elementsAdminAbout">
						<p>Recommendation</p>
						<textarea rows="4" id="FormInput" name="Recommendation" required></textarea>
					</div>
					
					<div class="ButtonAdminAbout">
						<button type="submit"  ID="button" name="Insert" href="/">Insert Information</button>
						<button type="submit"  ID="button" name="Delete" href="/">Delete Information</button>
					</div>
