	...
	<div class="main">
		...
		<div class="rsideAdmin">
			<div class="outterakbox">
				<form action="{{action('FormController@adminadminresume')}}" method="POST">
					{{csrf_field()}}
					<div class="head">
						<h2>Resume DETAILS ACCESS</h2>
					</div>
					<div class="elementsAdminAbout">
						<p>Company Name</p>
					
						<input type="text" name="Company"  id="FormInput" required>
					</div>
					<div class="elementsAdminAbout">
						<p>Post Title</p>
						<input type="text" name="Post"  id="FormInput" required>
					</div>
					<div class="elementsAdminAbout">
						<p>Start Date</p>
						<input type="date" name="Start"  id="FormInput" required>
					</div>
					<div class="elementsAdminAbout">
						<p>End Date</p>
						<input type="date" name="End"  id="FormInput" required>
					</div>
					<div class="elementsAdminAbout">
						<p>Year of Start</p>
						<input type="text" name="Year"  id="FormInput" required>
					</div>
					
					<div class="ButtonAdminAbout">
						<button type="submit"  ID="button" name="Insert" >Insert Information</button>
						<button type="submit"  ID="button" name="Delete" >Delete Information</button>
					</div>
