...
<!----`hireme`(`Cost`, `JobTitle`, `Task`, `JobID`, `IDGenerated`--->
		...
		<div class="rsideAdmin">
			<div class="outterakbox">
				<form action="{{action('FormController@adminhiremeinsert')}}" method="POST">
					{{csrf_field()}}
					<div class="head">
					...
					<div class="elementsAdminAbout">
						...
						<input type="text" name="Cost"  id="FormInput" required>
					</div>
					<div class="elementsAdminAbout">
						<p>JOB Title</p>
					...
					<div class="elementsAdminAbout">
						<p>Task</p>
						<textarea rows="4" id="FormInput" name="Task" required></textarea>
					</div>
